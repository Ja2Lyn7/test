...
if(isset($_POST['postFile'])){
    ...
    $target_path = FULFILLMENT_UPLOAD;
	...
	if(move_uploaded_file($_FILES['uploadedFile']['tmp_name'], $target_path)) {
		...
		while(($data = fgetcsv($handle, 1000, ",")) !== FALSE){
			...
			if($row>=0){
				...
				insertTrackingNumbers($activityId,$trackingNo);
			}
			$row++;
		}
		fclose($handle);
...
<div id="container">
    ...
    <div id="content" style="height:500px;">
    	...
    	<h1>Update Fulfillment Tracking</h1>
    	<?php echo $errmsg; ?>
        <?php echo $msg; ?>
        
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
        <p><b>Upload tracking numbers</b></p>
        ...
        <input type="hidden" name="pg" value="tracking" />                                                            
		</form>
