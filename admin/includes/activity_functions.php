...
function activityCount($startDate,$endDate,$value,$searchBy){

	global $connection;
	//Call activityCount
   	$sql = "CALL activityCount(?,?,?,?)";  
...
function activitySearch($startDate,$endDate,$start,$limit,$value,$searchBy) {

    global $connection;

    $sql = "CALL activitySearch(?,?,?,?,?,?)"; 
	...
	$stmt->bind_param('ssiiss', $p1, $p2, $p3, $p4, $p5, $p6);
